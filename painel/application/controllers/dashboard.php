...
class Dashboard extends CI_Controller {
    ...
    public function index()
    {
        ...
        $view['agendas'] = $this->tb_agenda_model->fetch_all_dia();
        $view['agendasTomorrow'] = $this->tb_agenda_model->fetch_all_amanha();
        $view['avisos'] = $this->tb_avisos_model->fetch_all();
        $view['user'] = $this->session->userdata('contrato_user');
