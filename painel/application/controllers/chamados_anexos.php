...
class Chamados_anexos extends CI_Controller {
    ...
    public function index($state = null, $id_chamado = null)
    {
        ...
        $crud->set_table('tb_chamados_anexos');
        $crud->set_subject('anexos do chamado');
        $crud->columns('id_chamado', 'arquivo');

        $crud->required_fields('id_chamado', 'arquivo');
        ...
        $output->content    = 'template/chamados_anexos/index';
