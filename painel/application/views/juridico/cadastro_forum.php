<div class="main-header">
	<h2>Cadastro Vara e Fórum</h2>
	<em>Cadastro de vara e fórum</em>
</div>
...
<?php echo form_open( 'juridico/cadastro_forum' , array('class' => 'form-horizontal label-left', 'role' => 'form') ); ?>
	...
	<div class="widget pessoa-fisica">
		...
		<div class="widget-content">
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php echo form_input(array('name' => 'forum','class' => 'form-control' ,  'id' => 'forum'), set_value('forum', @$processo->forum )); ?>
