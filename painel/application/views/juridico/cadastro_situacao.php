<div class="main-header">
	<h2>Cadastro Situação</h2>
	<em>Cadastro de situação</em>
</div>
...
<?php echo form_open( 'juridico/cadastro_situacao' , array('class' => 'form-horizontal label-left', 'role' => 'form') ); ?>
	...
	<div class="widget pessoa-fisica">
		...
		<div class="widget-content">
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php echo form_input(array('name' => 'situacao','class' => 'form-control' ,  'id' => 'situacao'), set_value('situacao', @$processo->situacao )); ?>
