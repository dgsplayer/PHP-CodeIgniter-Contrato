...
<div class="main-header">
    <div class="col-md-4">
        ...
        <em>Informações do contas a receber</em>
    </div>
    <div class="col-md-8">
...
<form action="busca_receber" method="POST">
    <div class="form-group">
        <a class="btn btn-primary" href="<?php echo base_url('financeiro/cadastro_receber'); ?>"> + Adicionar Receita</a>
        <!--	<a class="btn btn-primary" href="--><?php //echo base_url('financeiro/receber_xls'); ?><!--"> Gerar Arquivo</a>-->
    ...
    <div class="widget-content">
        <div class="form-group">
            ...
            <div class="demo-popover2">
                <div class="col-sm-4">
                    <p><a class="btn btn-link" href="#" data-content="Soma dos lançamentos recebidos" data-placement="left" data-toggle="popover" data-container="body" type="button" data-original-title="" title="">?</a> Saldo atual: R$ <?php echo (tracoVazio(number_format($atual,2,',','.'))); ?></p>
                    <p><a class="btn btn-link" href="#" data-content="Soma dos lançamentos à receber" data-placement="left" data-toggle="popover" data-container="body" type="button" data-original-title="" title="">?</a> Saldo à receber: R$ <?php echo (tracoVazio(number_format($a_processar,2,',','.'))); ?></p>
                </div>
            </div>
        </div>
    </div>
...
<div class="widget widget-table">
    <div class="widget-header">
        <h3><i class="fa fa-table"></i>Contas a Receber</h3>
    </div>
    <div class="widget-content">
            ...
            <?php if(isset($financeiros) && count($financeiros)) { ?>
                <?php foreach( $financeiros as $financeiro ) { ?>
                    <tr>
                        ...
                        <td><?php echo ($financeiro->pago)? 'Recebido' : 'À Receber'; ?></td>
                        <td>
                            <a href="<?php echo base_url('financeiro/cadastro_receber/'. $financeiro->id ); ?>" class="btn btn-info btn-sm">
