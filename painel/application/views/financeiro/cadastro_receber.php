...
<?php echo form_open( base_url('financeiro/processa_conta'), array('class' => 'form-horizontal label-left', 'role' => 'form') ); ?>
    ...
    <div class="widget pessoa-fisica">
        <div class="widget-header">
            <h3><i class="fa fa-edit"></i> Contas a Receber</h3>
        </div>
        <div class="widget-content">
            <div class="form-group">
                <div class="col-sm-6">
                    <label class="control-label">Descrição da receita</label>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <div>
                        <?php echo form_radio('pago', '1',(@$financeiro->pago == 1)); ?> Recebido <?php echo form_radio('pago', '0', (@$financeiro->pago == 0)); ?> À Receber
                    </div>
                </div>
            </div>
            <div class="form-group">
...
<?php echo form_hidden('tipo', 'RECEITA' ); ?>
