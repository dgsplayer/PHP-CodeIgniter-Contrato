<?php echo $this->load->helper('date'); ?>
    <div class="main-header">
        <div class="col-md-5">
            ...
            <em>Campos com dados do fornecedor</em>
        </div>
        <div class="col-md-7">
                    ...
                    <li>
                        <a href="<?php echo base_url('fornecedor'); ?>">
                            <div class="quick-access-item bg-color-yellow">
                                ...
                                <h5>Lista de fornecedor</h5>
                                <em>Clique aqui para listar fornecedor</em>
                            </div>
                        </a>
                    </li>
                </ul>
...
<?php echo form_open( 'fornecedor/processa_cadastro', array('class' => 'form-horizontal label-left', 'role' => 'form') )?>
