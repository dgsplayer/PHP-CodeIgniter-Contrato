...
<div class="main-heade">
    <h2>Informações Gerais do Cliente</h2>
</div>
<BR>
...
<div class="user-info-right">
    <div class="basic-info">
        <h3><i class="fa fa-square"></i> Dados do Cliente</h3>
        <p class="data-row">
        ...
        <p class="data-row">
            ...
            <span class="data-value"><?php echo(RetornaEstadoCivil($cliente->estado_civil)) ?></span>
        </p>
        <?php } ?>
...
<div class="row">
    <div class="col-md-4">
        <a href="<?php echo base_url('cliente/cadastro/' . $cliente->id_pessoa ); ?>" class="btn btn-info btn-block"><i class="fa fa-edit"></i> Editar</a>
    </div>
    <?php if($cliente->ativo == '1') { ?>
    <div class="col-md-4">
        <a href="<?php echo base_url('cliente/delete/' . $cliente->id_pessoa ); ?>"  onclick="return ask_delete();" class="btn btn-danger btn-block"><i class="fa fa-ban"></i> Excluir</a>
    </div>
    <?php } ?>
</div>
</div>
<div class="col-md-6">
    <div class="user-info-left">
        <div class="contact">
            ...
            <?php } ?>
            <h3><i class="fa fa-square"></i> Histórico do Cliente</h3>
            <BR>
            <?php echo form_open( 'cliente/detalhe/' . $cliente->id_pessoa, array('class' => 'form-horizontal label-left', 'role' => 'form') )?>
            <div class="row">
                <div class="col-md-9">

                    <textarea maxlength="400" class="form-control" name="descricao" rows="1" placeholder="Descreva uma observação sobre este cliente"></textarea>
                ...
                <table class="table table-sorting table-striped table-hover datatable" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <?php if(isset($historicos) && count($historicos)) { ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a onclick="return ask_delete();" href="<?php echo base_url('cliente/delete_historico/' . $historico->id ); ?>">Remover</a>
                            </td>
                        </tr>
                            <?php } ?>
                        <?php } else { ?>
